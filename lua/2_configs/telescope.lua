...
vim.keymap.set("n", "<space>gcs", builtin.grep_string, { desc = "[G]rep [C]urrent [S]tring" })
...
require("search").setup({
  ...
  tabs = {
    ...
    { "Symbols", tele_func = builtin.lsp_document_symbols },
    { "Workspace Symbols", tele_func = builtin.lsp_workspace_symbols },
    { "Diagnostics", tele_func = builtin.diagnostics },
  },
  collections = {
      -- TODO add payment specific filters
      -- TODO add test specific fitlers
     -- lsp = {
     --   initial_tab = 1, -- Git branches
     --   tabs = {
     --     -- { name = "References", tele_func = builtin.lsp_references },
     --     { name = "Symbols", tele_func = builtin.lsp_document_symbols },
     --     -- { name = "Workspace Symbols", tele_func = builtin.lsp_workspace_symbols },
     --     -- { name = "Implementations", tele_func = builtin.lsp_implementations },
     --     -- { name = "Definitions", tele_func = builtin.lsp_definitions },
     --     -- { name = "Type Definitions", tele_func = builtin.lsp_type_definitions },
     --     { name = "Diagnostics", tele_func = builtin.diagnostics },
     --   }
     -- }
   }
})

vim.keymap.set("n", "<space>os", "<cmd>lua require('search').open()<cr>", { desc = "Open Search" })
