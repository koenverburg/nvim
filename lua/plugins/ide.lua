...
return {
  ...
  lazy = false,
  keys = {
    { "<leader>e", "<cmd>Workspace LeftPanelToggle<cr>", desc = "toggle code explorer panel" },
    { "<leader>G", "<cmd>Workspace RightPanelToggle<cr>", desc = "toggle git explorer panel" },
    { "<C-l>hi", "<cmd>Workspace CallHierarchy IncomingCalls<cr>", desc = "incoming calls" },
    { "<C-l>ho", "<cmd>Workspace CallHierarchy OutgoingCalls<cr>", desc = "outgoing calls" },
  },
  config = function()
    -- default components
