-- Kudso to https://github.com/Wansmer for creating this setup
...
function HighlightedFoldtext()
  ...
  -- Removed Icon and replaced it with an empty space
  local folded = {
    { " " },
...
local function set_fold_hl()
  ...
  vim.api.nvim_set_hl(0, "FoldedColumn", { fg = comment.fg })
end
